...
@section('content')
    <section class="w-full bg-white dark:bg-background-dark pt-8 pb-12">
        <div class="max-w-[1280px] mx-auto px-4 lg:px-10">
            <x-web.form-wrapper action="{{ route('web.setup-company', ['uuid' => $user->uuid]) }}">
                <div class="flex flex-col lg:flex-row gap-10">
                    ...
                    <div class="flex-1 space-y-8">
                        ...
                        <section
                            ...
                            <h2
                                class="text-[#121118] dark:text-white text-[22px] font-bold leading-tight tracking-[-0.015em] mb-6">
                                Media Assets
                            </h2>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="relative group">
                                    ...
                                    <div id="bannerPreview"
                                        ...
                                        style='background-image: linear-gradient(rgba(0,0,0,0.1), rgba(0,0,0,0.3)), url("https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200")'>
                                        <div
                            ...
                            <div class="flex items-center gap-6">
                                <div class="relative">
                                    ...
                                    <div id="logoPreview"
                                        ...
                                        style='background-image: url("https://ui-avatars.com/api/?name=Company&size=128&background=6366f1&color=fff")'>
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <input id="companyName" name="company_name"
                                        ...
                                        type="text" value="{{ old('company_name') }}" required />
                                    @error('company_name')
                                ...
                                <div class="flex flex-col gap-2 md:col-span-2">
                                    ...
                                    <textarea id="companyBio" name="company_bio"
                                        ...
                                        placeholder="Describe your company culture, mission, and what makes you unique..." rows="6" maxlength="1000">{{ old('company_bio') }}</textarea>
                            ...
                            <div
                                ...
                                <div class="px-5 pb-6">
                                    ...
                                    <div class="relative -mt-10 mb-4">
                                        <div
                                            class="size-20 rounded-xl bg-white border dark:bg-background-dark p-1 shadow-md">
                                            <div id="previewLogo" class="size-full bg-center bg-cover rounded-lg"
                                                style='background-image: url("https://ui-avatars.com/api/?name=Company&size=80&background=6366f1&color=fff")'>
                                            </div>
                                        </div>
                                    </div>
