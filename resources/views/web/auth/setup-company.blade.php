                ...
                <div class="flex flex-col lg:flex-row gap-10">
                    ...
                    <div class="flex-1 space-y-8">
                        ...
                        <section
                            ...
                            <!-- Banner Upload -->
                            <div class="mb-8">
                                <label class="block text-sm font-semibold mb-3 text-gray-700 dark:text-gray-300">Banner
                                    Image</label>
                    ...
                    <aside class="w-full lg:w-[380px] shrink-0">
                        <div class="sticky top-24">
                            <div class="flex items-center justify-between mb-4 px-1">
                                <span
                                    class="text-sm font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Public
                                    View
                                    Preview</span>
                                ...
                                <div class="px-5 pb-6">
                                    ...
                                    <div class="relative -mt-10 mb-4">
                                        <div
                                            ...
                                            <div class="size-full bg-center bg-cover rounded-lg"
                                                data-alt="Small tech company logo"
                                    ...
                                    <div class="flex items-center gap-2 mb-4">
                                        <span
                                            class="text-primary text-xs font-semibold bg-primary/10 px-2 py-0.5 rounded">Tech
                                            &amp;
                                            Software</span>
                                        <span class="text-gray-400 text-xs">•</span>
                                        <span class="text-gray-500 dark:text-gray-400 text-xs font-medium">51-200
                                            Employees</span>
                                    </div>
                                    <p class="text-sm text-gray-600 dark:text-gray-300 line-clamp-4 leading-relaxed mb-6">
                                        InnovateTech Solutions is a leading provider of enterprise cloud software, helping
                                        organizations
                                        accelerate their digital transformation. Founded in 2015, we've grown into a global
                                        team of
                                        over
